...
const SERVICES = [
  ...
  { num: "02", name: "Ортодонтическое лечение", desc: "Брекеты, элайнеры, ортодонтические аппараты" },
  { num: "03", name: "Эстетическая реставрация", desc: "Виниры, коронки, отбеливание" },
  { num: "04", name: "Профессиональная гигиена", desc: "Чистка, полировка, обучение гигиене " },
  { num: "05", name: "Лечение корневых каналов", desc: "Эндодонтия под микроскопом" },
  { num: "06", name: "Детская стоматология", desc: "Бережное лечение от 7 лет" },
];
